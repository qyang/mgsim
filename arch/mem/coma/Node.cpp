...
COMA::Node::Node(const std::string& name, COMA& parent, Clock& clock, Config& config)
    : Simulator::Object(name, parent),
      ...
      m_prev(NULL),
      m_next(NULL),
      m_incoming("b_incoming", *this, clock, config.getValue<BufferSize>(*this, "NodeBufferSize", 0)),
      m_outgoing("b_outgoing", *this, clock, config.getValue<BufferSize>(*this, "NodeBufferSize", 0)),
